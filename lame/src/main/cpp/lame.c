...
Java_top_andnux_lame_LameNative_convert(JNIEnv *env, jclass instance, jstring input_,
                                               jstring output_) {
...
JNIEXPORT void JNICALL
Java_top_andnux_lame_LameNative_init(JNIEnv *env, jclass type, jint samplerate,
...
JNIEXPORT void JNICALL
Java_top_andnux_lame_LameNative_destroy(JNIEnv *env, jclass type) {
...
Java_top_andnux_lame_LameNative_encode(JNIEnv *env, jclass type, jshortArray buffer_l,jshort buffer_r,
                                              jint len) {
...
Java_top_andnux_lame_LameNative_getVersion(JNIEnv *env, jclass type) {
