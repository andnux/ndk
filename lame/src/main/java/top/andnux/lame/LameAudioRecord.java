...
public class LameAudioRecord {
    ...
    private LameAudioRecordListener mListener;
    private volatile int state; //录音状态
    private Handler mHandler;

    interface  LameAudioRecordListener{
        void  initError();
        void  recordErroor();
        void  onSuccess(String path);
    }

    public void setLameAudioRecordListener(LameAudioRecordListener listener) {
        mListener = listener;
    }

    public LameAudioRecord() {
