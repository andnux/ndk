...
JNIEXPORT void JNICALL
Java_top_andnux_zbar_SymbolSet_init(JNIEnv *env,
                                            jclass cls) {
    SymbolSet_peer = (*env)->GetFieldID(env, cls, "peer", "J");
}

JNIEXPORT void JNICALL
Java_top_andnux_zbar_SymbolSet_destroy(JNIEnv *env,
                                               jobject obj,
                                               jlong peer) {
...
JNIEXPORT jint JNICALL
Java_top_andnux_zbar_SymbolSet_size(JNIEnv *env,
                                            jobject obj) {
...
Java_top_andnux_zbar_SymbolSet_firstSymbol(JNIEnv *env,
                                                   jobject obj,
                                                   jlong peer) {
    if (!peer)
        return (0);
...
JNIEXPORT void JNICALL
Java_top_andnux_zbar_Symbol_init(JNIEnv *env,
                                         jclass cls) {
    Symbol_peer = (*env)->GetFieldID(env, cls, "peer", "J");
}

JNIEXPORT void JNICALL
Java_top_andnux_zbar_Symbol_destroy(JNIEnv *env,
                                            jobject obj,
                                            jlong peer) {
...
JNIEXPORT jint JNICALL
Java_top_andnux_zbar_Symbol_getType(JNIEnv *env,
                                            jobject obj,
                                            jlong peer) {
...
JNIEXPORT jint JNICALL
Java_top_andnux_zbar_Symbol_getConfigMask(JNIEnv *env,
                                                  jobject obj) {
    return (zbar_symbol_get_configs(GET_PEER(Symbol, obj)));
}

JNIEXPORT jint JNICALL
Java_top_andnux_zbar_Symbol_getModifierMask(JNIEnv *env,
                                                    jobject obj) {
    return (zbar_symbol_get_modifiers(GET_PEER(Symbol, obj)));
}

JNIEXPORT jstring JNICALL
Java_top_andnux_zbar_Symbol_getData(JNIEnv *env,
                                            jobject obj) {
...
JNIEXPORT jstring JNICALL
Java_top_andnux_zbar_Symbol_getDataBytes(JNIEnv *env,
                                                 jobject obj) {
...
JNIEXPORT jint JNICALL
Java_top_andnux_zbar_Symbol_getQuality(JNIEnv *env,
                                               jobject obj) {
    return (zbar_symbol_get_quality(GET_PEER(Symbol, obj)));
}

JNIEXPORT jint JNICALL
Java_top_andnux_zbar_Symbol_getCount(JNIEnv *env,
                                             jobject obj) {
    return (zbar_symbol_get_count(GET_PEER(Symbol, obj)));
}

JNIEXPORT jint JNICALL
Java_top_andnux_zbar_Symbol_getLocationSize(JNIEnv *env,
                                                    jobject obj,
                                                    jlong peer) {
...
JNIEXPORT jint JNICALL
Java_top_andnux_zbar_Symbol_getLocationX(JNIEnv *env,
                                                 jobject obj,
                                                 jlong peer,
                                                 jint idx) {
...
JNIEXPORT jint JNICALL
Java_top_andnux_zbar_Symbol_getLocationY(JNIEnv *env,
                                                 jobject obj,
                                                 jlong peer,
                                                 jint idx) {
...
JNIEXPORT jint JNICALL
Java_top_andnux_zbar_Symbol_getOrientation(JNIEnv *env,
                                                   jobject obj) {
    return (zbar_symbol_get_orientation(GET_PEER(Symbol, obj)));
}

JNIEXPORT jlong JNICALL
Java_top_andnux_zbar_Symbol_getComponents(JNIEnv *env,
                                                  jobject obj,
                                                  jlong peer) {
...
JNIEXPORT jlong JNICALL
Java_top_andnux_zbar_Symbol_next(JNIEnv *env,
                                         jobject obj) {
...
JNIEXPORT void JNICALL
Java_top_andnux_zbar_Image_init(JNIEnv *env,
                                        jclass cls) {
...
JNIEXPORT jlong JNICALL
Java_top_andnux_zbar_Image_create(JNIEnv *env,
                                          jobject obj) {
...
JNIEXPORT void JNICALL
Java_top_andnux_zbar_Image_destroy(JNIEnv *env,
                                           jobject obj,
                                           jlong peer) {
...
JNIEXPORT jlong JNICALL
Java_top_andnux_zbar_Image_convert(JNIEnv *env,
                                           jobject obj,
                                           jlong peer,
                                           jstring format) {
    ...
    if (!zimg)
        throw_exc(env, "java/lang/UncoreedOperationException",
                  "uncoreed image format");
    else
        stats.Image_create++;
    return ((intptr_t) zimg);
}
...
JNIEXPORT jstring JNICALL
Java_top_andnux_zbar_Image_getFormat(JNIEnv *env,
                                             jobject obj) {
...
JNIEXPORT void JNICALL
Java_top_andnux_zbar_Image_setFormat(JNIEnv *env,
                                             jobject obj,
                                             jstring format) {
    uint32_t fourcc = format_to_fourcc(env, format);
    if (!fourcc)
...
JNIEXPORT jint JNICALL
Java_top_andnux_zbar_Image_getSequence(JNIEnv *env,
                                               jobject obj) {
    return (zbar_image_get_sequence(GET_PEER(Image, obj)));
}

JNIEXPORT void JNICALL
Java_top_andnux_zbar_Image_setSequence(JNIEnv *env,
                                               jobject obj,
                                               jint seq) {
...
JNIEXPORT jint JNICALL
Java_top_andnux_zbar_Image_getWidth(JNIEnv *env,
                                            jobject obj) {
    return (zbar_image_get_width(GET_PEER(Image, obj)));
}

JNIEXPORT jint JNICALL
Java_top_andnux_zbar_Image_getHeight(JNIEnv *env,
                                             jobject obj) {
    return (zbar_image_get_height(GET_PEER(Image, obj)));
}

JNIEXPORT jobject JNICALL
Java_top_andnux_zbar_Image_getSize(JNIEnv *env,
                                           jobject obj) {
...
JNIEXPORT void JNICALL
Java_top_andnux_zbar_Image_setSize__II(JNIEnv *env,
                                               jobject obj,
                                               jint width,
                                               jint height) {
    if (width < 0) width = 0;
...
JNIEXPORT void JNICALL
Java_top_andnux_zbar_Image_setSize___3I(JNIEnv *env,
                                                jobject obj,
                                                jintArray size) {
...
JNIEXPORT jobject JNICALL
Java_top_andnux_zbar_Image_getCrop(JNIEnv *env,
                                           jobject obj) {
...
JNIEXPORT void JNICALL
Java_top_andnux_zbar_Image_setCrop__IIII(JNIEnv *env,
                                                 jobject obj,
                                                 jint x, jint y,
                                                 jint w, jint h) {
    VALIDATE_CROP(x, w);
...
JNIEXPORT void JNICALL
Java_top_andnux_zbar_Image_setCrop___3I(JNIEnv *env,
                                                jobject obj,
                                                jintArray crop) {
...
JNIEXPORT jobject JNICALL
Java_top_andnux_zbar_Image_getData(JNIEnv *env,
                                           jobject obj) {
...
JNIEXPORT void JNICALL
Java_top_andnux_zbar_Image_setData___3B(JNIEnv *env,
                                                jobject obj,
                                                jbyteArray data) {
    jbyte *raw = NULL;
...
JNIEXPORT void JNICALL
Java_top_andnux_zbar_Image_setData___3I(JNIEnv *env,
                                                jobject obj,
                                                jintArray data) {
    jint *raw = NULL;
    unsigned long rawlen = 0;
...
JNIEXPORT jlong JNICALL
Java_top_andnux_zbar_Image_getSymbols(JNIEnv *env,
                                              jobject obj,
                                              jlong peer) {
...
JNIEXPORT void JNICALL
Java_top_andnux_zbar_ImageScanner_init(JNIEnv *env,
                                               jclass cls) {
    ImageScanner_peer = (*env)->GetFieldID(env, cls, "peer", "J");
}

JNIEXPORT jlong JNICALL
Java_top_andnux_zbar_ImageScanner_create(JNIEnv *env,
                                                 jobject obj) {
...
JNIEXPORT void JNICALL
Java_top_andnux_zbar_ImageScanner_destroy(JNIEnv *env,
                                                  jobject obj,
                                                  jlong peer) {
...
JNIEXPORT void JNICALL
Java_top_andnux_zbar_ImageScanner_setConfig(JNIEnv *env,
                                                    jobject obj,
                                                    jint symbology,
                                                    jint config,
                                                    jint value) {
...
JNIEXPORT void JNICALL
Java_top_andnux_zbar_ImageScanner_parseConfig(JNIEnv *env,
                                                      jobject obj,
                                                      jstring cfg) {
...
JNIEXPORT void JNICALL
Java_top_andnux_zbar_ImageScanner_enableCache(JNIEnv *env,
                                                      jobject obj,
                                                      jboolean enable) {
...
JNIEXPORT jlong JNICALL
Java_top_andnux_zbar_ImageScanner_getResults(JNIEnv *env,
                                                     jobject obj,
                                                     jlong peer) {
    const zbar_symbol_set_t *zsyms =
...
JNIEXPORT jint JNICALL
Java_top_andnux_zbar_ImageScanner_scanImage(JNIEnv *env,
                                                    jobject obj,
                                                    jobject image) {
